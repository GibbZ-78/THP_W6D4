class PrivateMessage < ApplicationRecord
  ...
  belongs_to :previous_messages, foreign_key: 'previous_message_id', 
                                 class_name: "PrivateMessage",
                                 optional: true                           # 1 message can be linked to 0..N parent messages, but can also be the first one of the discussion (nil).
end
